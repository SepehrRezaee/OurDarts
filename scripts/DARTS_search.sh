...
python /kaggle/input/OurDarts/src/search/train_search.py --unrolled --job_id 1 --task_id 1 --seed 2 --cutout --report_freq_hessian 2 --space $1 --dataset $2 --drop_path_prob $3 --weight_decay $4
